 ...
 */
final class Version20220406222308 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    {
        $this->addSql('ALTER TABLE password_resets DROP INDEX UNIQ_9EDAFEA1A76ED395, ADD INDEX IDX_9EDAFEA1A76ED395 (user_id)');
        $this->addSql('ALTER TABLE password_resets DROP executed');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE password_resets DROP INDEX IDX_9EDAFEA1A76ED395, ADD UNIQUE INDEX UNIQ_9EDAFEA1A76ED395 (user_id)');
        $this->addSql('ALTER TABLE password_resets ADD executed TINYINT(1) NOT NULL, CHANGE token token LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Password reset token\'');
