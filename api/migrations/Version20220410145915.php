 ...
 */
final class Version20220410145915 extends AbstractMigration
{
    /**
     * @param Schema $schema
     *
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE albums CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Album name\', CHANGE photo photo LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Link to album photo\', CHANGE tags tags LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'Album tags(DC2Type:array)\'');
