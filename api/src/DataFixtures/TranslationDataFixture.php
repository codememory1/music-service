...
final class TranslationDataFixture extends AbstractDataFixture implements DependentFixtureInterface, FixtureGroupInterface
{
    ...
    public function __construct()
    {
        parent::__construct([
            ...
            new TranslationFactory('ru', 'common@authFromUnknownDeviceMessage', 'На ваш аккаунт был выполнен вход с незнакомого устройства. Название устройства: "%device%", IP-адрес: "%ip%"'),
            ...
            new TranslationFactory('ru', 'entityNotFound@multimediaCategory', 'Категория мультимедиа не найдена'),
            new TranslationFactory('ru', 'entityNotFound@performer', 'Исполнитель %performer% не найден'),
            new TranslationFactory('ru', 'entityNotFound@multimedia', 'Мультимедиа не найдена'),
            ...
            new TranslationFactory('ru', 'auth@authNotRequired', 'Для выполнения данного действия вы должны выйти из аккаунта'),
            ...
            new TranslationFactory('ru', 'registration@didNotProvideData', 'Сервис не может зарегистрировать из-за отсутствия запрашиваемых данных'),
            ...
            new TranslationFactory('ru', 'rolePermission@showFullInfoMultimediaCategories', 'Просмотр полной информации о категориях мультимедиа'),
            new TranslationFactory('ru', 'rolePermission@createMultimediaCategory', 'Создание категории мультимедиа'),
            new TranslationFactory('ru', 'rolePermission@updateMultimediaCategory', 'Обновление категории мультимедиа'),
            new TranslationFactory('ru', 'rolePermission@deleteMultimediaCategory', 'Удаление категории мультимедиа'),
            new TranslationFactory('ru', 'rolePermission@multimediaStatusControlToUser', 'Управление статусами мультимедиа пользователей'),
            new TranslationFactory('ru', 'rolePermission@showAllUserMultimedia', 'Просмотр мультимедиа пользователей'),
            new TranslationFactory('ru', 'rolePermission@addMultimediaToUser', 'Добавление мультимедиа к пользователю'),
            new TranslationFactory('ru', 'rolePermission@updateMultimediaToUser', 'Обновление мультимедиа пользователя'),
            new TranslationFactory('ru', 'rolePermission@deleteMultimediaToUser', 'Просмотр мультимедиа пользователей'),
            ...
            new TranslationFactory('ru', 'rolePermission@showMediaLibraryToUser', 'Просмотр мультимедиа пользователя'),
            new TranslationFactory('ru', 'rolePermission@deleteMultimediaMediaLibraryToUser', 'Удаление мультимедиа из медиатеки пользователя'),
            new TranslationFactory('ru', 'rolePermission@deleteMultimediaFromMediaLibraryToUser', 'Удаление мультимедиа из медиатеки пользователя'),
            ...
            new TranslationFactory('ru', 'rolePermission@showAllBranch', 'Просмотр всех веток'),
            ...
            new TranslationFactory('ru', 'role@systemUserDescription', 'Данная роль предназначена только для системных пользователей, под которыми невозможно войти'),
            ...
            new TranslationFactory('ru', 'subscription@artistDescription', 'Загружайте музыку и зарабатывайте с помощью монетизации'),
            ...
            new TranslationFactory('ru', 'subscriptionPermissionKey@addMultimedia', 'Добавление мультимедиа'),
            ...
            new TranslationFactory('ru', 'subscriptionPermissionKey@listeningToMultimedia', 'Прослушивание мультимедиа артистов'),
            ...
            new TranslationFactory('ru', 'album@maxDescriptionLength', 'Описание альбома не должно превышать 255 символов'),
            ...
            new TranslationFactory('ru', 'multimediaCategory@successCreate', 'Категория мультимедиа успешно создана'),
            new TranslationFactory('ru', 'multimediaCategory@successUpdate', 'Категория мультимедиа успешно обновлена'),
            new TranslationFactory('ru', 'multimediaCategory@successDelete', 'Категория мультимедиа успешно удалена'),

            new TranslationFactory('ru', 'multimedia@typeIsRequired', 'Тип мультимедиа обязательный к заполнению'),
            new TranslationFactory('ru', 'multimedia@albumIsRequired', 'Альбом обязательный к заполнению'),
            new TranslationFactory('ru', 'multimedia@titleIsRequired', 'Название мультимедиа обязательно к заполнению'),
            new TranslationFactory('ru', 'multimedia@titleMaxLength', 'Название мультимедиа не должно превышать 50 символов'),
            new TranslationFactory('ru', 'multimedia@descriptionMaxLength', 'Описание мультимедиа не должно превышать 500 символов'),
            new TranslationFactory('ru', 'multimedia@categoryIsRequired', 'Категория мультимедиа обязательна к заполнению'),
            new TranslationFactory('ru', 'multimedia@uploadFileIsNotSubtitles', 'Загружаемый файл не является субтитрами'),
            new TranslationFactory('ru', 'multimedia@isObsceneWordsIsRequired', 'Выберите, содержится ли нецензурная лексика в мультимедиа'),
            ...
            new TranslationFactory('ru', 'multimedia@successAdd', 'мультимедиа успешно добавлена и ожидает отправки на модерацию'),
            ...
            new TranslationFactory('ru', 'multimedia@multimediaIsRequired', 'Файл мультимедиа обязательный к заполнению'),
            new TranslationFactory('ru', 'multimedia@badSendOnModeration', 'Невозможно отправить мультимедиа на модерацию'),
            new TranslationFactory('ru', 'multimedia@successSendOnModeration', 'Мультимедиа успешно отправлена на модерацию'),
            new TranslationFactory('ru', 'multimedia@successUpdate', 'Мультимедиа успешно обновлена'),
            new TranslationFactory('ru', 'multimedia@successDelete', 'Мультимедиа успешно удалена'),
            new TranslationFactory('ru', 'multimedia@badUpdateInStatus', 'Невозможно обновить мультимедиа в статусе %status%'),
            new TranslationFactory('ru', 'multimedia@successSendOnAppeal', 'Мультимедиа успешно отправлена на апелляцию'),
            new TranslationFactory('ru', 'multimedia@badSendOnAppeal', 'Невозможно отправить мультимедиа на апелляцию в статусе %status%'),
            new TranslationFactory('ru', 'multimedia@badPublish', 'Невозможно опубликовать мультимедиа'),
            new TranslationFactory('ru', 'multimedia@badUnpublish', 'Невозможно снять с публикации мультимедиа'),
            ...
            new TranslationFactory('ru', 'streamMultimedia@toUserSessionIsRequired', 'Сессия обязательна к заполнению'),
