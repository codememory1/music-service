...
enum RolePermissionEnum
{
    ...
    case SHOW_ALL_USER_MULTIMEDIA_EXTERNAL_SERVICE;
    case ADD_MULTIMEDIA_EXTERNAL_SERVICE_TO_USER;
    case UPDATE_MULTIMEDIA_EXTERNAL_SERVICE_TO_USER;
    case DELETE_MULTIMEDIA_EXTERNAL_SERVICE_TO_USER;
}