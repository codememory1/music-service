...
import BaseSelectBoxCurrent from '~/components/UI/Select/BaseSelectBoxCurrent.vue';
import BaseSelectPlaceholder from '~/components/UI/Select/BaseSelectPlaceholder.vue';
import BaseSelectSelectedOption from '~/components/UI/Select/BaseSelectSelectedOption.vue';
import BaseSelectListSelectedTags from '~/components/UI/Select/BaseSelectListSelectedTags.vue';
import BaseSelectSelectedTag from '~/components/UI/Select/BaseSelectSelectedTag.vue';
import BaseSelectSearch from '~/components/UI/Select/BaseSelectSearch.vue';
import BaseSelectLoading from '~/components/UI/Select/BaseSelectLoading.vue';
import BaseSelectOptionList from '~/components/UI/Select/BaseSelectOptionList.vue';
import BaseSelectOption from '~/components/UI/Select/BaseSelectOption.vue';
import BaseSelectSearchNoMatchesFound from '~/components/UI/Select/BaseSelectSearchNoMatchesFound.vue';
...
export default class BaseSelect extends Vue {
  ...
  private search(event: InputEvent): void {
    ...
    this.options.forEach((el: SelectOptionType) => {
      const target = event.target as HTMLInputElement;

      if (el.title.search(new RegExp('^' + target.value, 'i')) !== -1) {
        options.push(el);
      }
    });
...
<style lang="scss">
@import '@/assets/scss/components/ui/select/base-select.scss';
</style>
