...
class User implements EntityInterface
{
	...
	public function hasPermission(RolePermissionNameEnum $permission): bool
	{
		...
		return $permissions->exists(function(RolePermissionName $rolePermissionName) use ($permission) {

			return $rolePermissionName->getKey() === $permission->value;
		});
	...
	public function hasSubscriptionPermission(string $key): bool
	{
		...
		return $permissions->exists(function(SubscriptionPermission $permission) use ($key) {

			return $permission->getSubscriptionPermissionName()->getKey() === $key;
		});
	...
	/**
	 * @param AuthRestriction|null $authRestriction
	 *
	 * @return $this
	 */
