 ...
 */
final class Version20220211195348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album_types CHANGE `key` `key` VARCHAR(255) NOT NULL COMMENT \'Unique album type\', CHANGE title_translation_key title_translation_key VARCHAR(255) NOT NULL COMMENT \'Type name translation key\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album_types CHANGE `key` `key` VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE title_translation_key title_translation_key VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
