 ...
 */
final class Version20220201235331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_activation_tokens (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, valid VARCHAR(10) NOT NULL COMMENT \'Token lifetime in CronTime format\', token LONGTEXT NOT NULL COMMENT \'Account activation token\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_39C07872A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
