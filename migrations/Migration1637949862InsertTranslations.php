...
final class Migration1637949862InsertTranslations extends AbstractMigration
{
    ...
    public function up(MigrationSchemaInterface $schema): void
    {
        ...
        $schema->insertRecords(['lang_id', 'translation_key_id', 'translation'], ...[
            ...
            [1, 93, 'Старый пароль'],
            [1, 94, 'Новый пароль'],
            [1, 95, 'Подвреждение пароля'],
            [1, 96, 'Обновить настройки безопаности'],
            [1, 97, 'Обновить'],
            [1, 98, 'Отменить'],
            [1, 99, 'Изменение пароля'],
            [1, 100, 'Рекомендация! Если увидели подозрительный сеанс, удалите его и смените пароль.'],
        ]);
